...
Library     String
Library     Process
Library     C:/Users/ThomasJ1/PycharmProjects/CRSITP2/Resources/Upload.py
...
EncodeCenodeathTransaction
    ...
    Input Text      ${cenodeath_personfirstname_text}      Jasmine
...
Encodingpiecemealcddeath
    ...
    sleep   2
    Wait Until Element Is Visible       ${piecemeal_regno_text}
    sleep  2
    input text  ${piecemeal_cddeath_regno_text}     2022-1000024
...
Encodingpiecemeallimarriage
    ...
    Wait Until Element Is Visible       ${piecemeal_regno_text}
    sleep  2
    click element  ${piecemeal_regno_text}


    input text  ${piecemeal_regno_text}     2022-1000028
    Press Keys      ${piecemeal_regno_text}    ENTER
    sleep   2
...
ProcessRAsingleannotationbirth
    ...
    sleep   2
    input text      ${annotation_processing_regno_text}     2020-1213000
    sleep   2
...
Encodepiecemealadministartivecorrectionbirth
    ...
    input text  ${piecemeal_adminbirth_regno_text}     2022-1000032
    ...
    input text      ${piecemeal_admin_motherlastname_text}      SONA
