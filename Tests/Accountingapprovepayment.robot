...
*** Variables ***
${files}        c:\users\thomasj1\PycharmProjects\CRSITP2\girl_205263.jpg
${browser}  chrome
...
Verify accountingapprovepaymentproof
    ...
    [Documentation]  Navigating to Accounting reports and verify consolidated collections report
